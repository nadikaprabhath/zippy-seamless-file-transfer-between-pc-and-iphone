...
<body>
    <div class="container">
        <h1 class="font-sans font-medium text-black flex items-center justify-center mt-3 mb-1 max-[375px]:justify-start sm:text-[50px] max-[375px]:text-[30px] sm:pb-2">Zippy</h1>
        <p class="flex items-center justify-center mb-7 font-sans text-gray-500 text-center max-[375px]:text-[14px] max-[375px]:justify-start sm:text-xl">Seamlessly transfer files between your devices</p>

        <div class="tabs sm:mt-20 sm:p-[5px]">
        ...
        <div id="upload-tab" class="tab-content">
            ...
            <span style="display: flex; align-items: center; gap: 10px; margin-bottom: 20px;">                
                ...
                <div class="truncate w-full overflow-hidden text-ellipsis whitespace-nowrap" id="selectedFiles" style="margin: 10px 0; color: #86868b;"></div>
            </div>
    ...
    <script>
        ...
        function renderFileGrid(files, container, downloadPath) {
            ...
            container.innerHTML = '<div class="file-grid">' + files.map(file => {
                ...
                return `
                    <div class="file-card">
                        <button class="delete-btn" onclick="deleteFile('${downloadPath}', '${file.name}')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash2 lucide-trash-2 h-4 w-4" aria-hidden="true"><path d="M10 11v6"></path><path d="M14 11v6"></path><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"></path><path d="M3 6h18"></path><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></button>
                        <a href="/download/${downloadPath}/${encodeURIComponent(file.name)}" style="flex: 1; display: flex; flex-direction: column;" download>
                            ${previewHtml}
